...
* `maplibre_gl/mapbox_gl.dart` was renamed to `maplibre_gl/maplibre_gl.dart`. You can do a replace-all from `import 'package:maplibre_gl/maplibre_gl.dart';` to `import 'package:maplibre_gl/maplibre_gl.dart';`
